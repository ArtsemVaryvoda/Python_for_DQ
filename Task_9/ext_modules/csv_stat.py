...
class CSVStat:
    def __init__(self, file_path, news_file):
    ...
    def word_count(self):
        word_pattern = r"\p{L}+"
        with open(f'{self.file_path}\\{self.news_file}') as text_file:
            words_dict = {}
    ...
    def create_letters_count_list(letters_list):
        ...
        for el in letters_list:
            ...
            psntg = round(((lwr + upr) / letters_list_len) * 100, 3)
            count_of_letters.append((el.lower(), lwr + upr, upr, psntg))
